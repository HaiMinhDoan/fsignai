...
<script lang="ts" setup>
  ...
  // public/resource/tinymce/langs chỉ có en.js (và zh_CN.js đã bỏ). TinyMCE
  // không có gói tiếng Việt, nên dùng tiếng Anh cho cả hai ngôn ngữ của trang.
  const langName = computed(() => 'en');
